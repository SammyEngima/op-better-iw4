...
heli_damage_monitor()
{
	...
	for( ;; )
	{
		...
		self waittill( "damage", damage, attacker, direction_vec, P, type, victim, vDir, sHitLoc, psOffsetTime, sWeapon );
		...
		if ( isPlayer( attacker ) )
		{
			...
			if(IsSubStr( sWeapon, "barrett" ))
				damage *= 6;
			if(IsSubStr( sWeapon, "cheytac" ))
				damage *= 3;
		}
