...
/*
	Global Thermal Nuclear War Improved by the BetterIW4 Project
*/
...
setupNukeSite()
{
	...
	nukeSite maps\mp\gametypes\_gameobjects::set2DIcon( "friendly", "dpad_killstreak_nuke");
	nukeSite maps\mp\gametypes\_gameobjects::set3DIcon( "friendly", "waypoint_defend" );

	nukeSite maps\mp\gametypes\_gameobjects::set2DIcon( "enemy", "dpad_killstreak_nuke" );
...
scoreCounter()
{
	...
	for ( ;; )
	{
		...
		if ( !self.touchList["axis"].size && !self.touchlist["allies"].size )
		{
			...
			self maps\mp\gametypes\_gameobjects::set2DIcon( "enemy", "dpad_killstreak_nuke" );
		...
		self maps\mp\gametypes\_gameobjects::set2DIcon( "friendly", "dpad_killstreak_nuke");
